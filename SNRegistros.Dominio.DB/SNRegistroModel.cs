namespace SNRegistros.Dominio.DB
{
    ...
    public partial class SNRegistroModel : DbContext
    {
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<AccionesJudiciale>()
                .Property(e => e.NombreAJ)
                .IsUnicode(false);

            modelBuilder.Entity<AccionesJudiciale>()
                .HasMany(e => e.RegistrosJudiciales)
                .WithRequired(e => e.AccionesJudiciale)
                .WillCascadeOnDelete(false);
            ...
            modelBuilder.Entity<AccionesPoliciale>()
                .HasMany(e => e.RegistrosPoliciales)
            ...
            modelBuilder.Entity<FuncionariosJudiciale>()
                .Property(e => e.Nombre)
                .IsUnicode(false);
            ...
            modelBuilder.Entity<FuncionariosJudiciale>()
                .HasMany(e => e.RegistrosJudiciales)
                .WithRequired(e => e.FuncionariosJudiciale)
                .WillCascadeOnDelete(false);
            ...
            modelBuilder.Entity<ProcesosJudiciale>()
                .HasMany(e => e.AccionesJudiciales)
            ...
            modelBuilder.Entity<RegistrosPoliciale>()
                .Property(e => e.Comentario)
                .IsUnicode(false);
        }
    }
